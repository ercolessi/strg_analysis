...
void DoMCStudies(TString mcname = "PythiaMonash_Train2627", Bool_t IsFullSim = kFALSE)
{
    ...
    TString outputfile = Form("FullResultsMC%sSim_%s.root",Type.Data(),mcname.Data());
...
void process(TString directory = "", TString outputfile = "", TString option = "RECREATE", TString mcname = "EPOSLHC", Double_t* SPDClperc = 0x0, Int_t nSPDCl = 0, Double_t* V0Mperc = 0x0, Int_t nV0M = 0, Bool_t IsFullSim = kTRUE){
    ...
    f2DHistQ2SPDV0M        = (TH2D*)list->FindObject("f2DHistQ2SPDV0M");
    f2DHistbSPDV0M         = (TH2D*)list->FindObject("f2DHistbSPDV0M");
