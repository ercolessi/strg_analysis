...
void DoSystOOB(TString lCascType = "Lambda"){
    ...
    // files
    // default
    TFile* fileDefPart  = TFile::Open(Form("files/Results-%s-13TeV-SPDClusters_000_100_V0M_000_100_FDUseMCRatio.root",
        particle.Data()),"READ");
    TH1D* hDefPart = (TH1D*)fileDefPart->Get(Form("fHistPt%s",particle.Data()));
    TFile* fileDefAntiPart  = TFile::Open(Form("files/Results-%s-13TeV-SPDClusters_000_100_V0M_000_100_FDUseMCRatio.root",
        antiparticle.Data()),"READ");
    TH1D* hDefAntiPart = (TH1D*)fileDefAntiPart->Get(Form("fHistPt%s",antiparticle.Data()));
    // ITS All
    TFile* fileITSAllPtPart  = TFile::Open(Form("files/Results-%s-13TeV-SPDClusters_000_100_V0M_000_100_FDUseMCRatio_ITSFullPt.root",
        particle.Data()),"READ");
    hResPart[0] = (TH1D*)fileITSAllPtPart->Get(Form("fHistPt%s",particle.Data()));
    TFile* fileITSAllPtAntiPart  = TFile::Open(Form("files/Results-%s-13TeV-SPDClusters_000_100_V0M_000_100_FDUseMCRatio_ITSFullPt.root",
        antiparticle.Data()),"READ");
    hResAntiPart[0] = (TH1D*)fileITSAllPtAntiPart->Get(Form("fHistPt%s",antiparticle.Data()));
    // ITS < 2 GeV/c
    TFile* fileITSlt2Part  = TFile::Open(Form("files/Results-%s-13TeV-SPDClusters_000_100_V0M_000_100_FDUseMCRatio_ITS2GeV.root",
        particle.Data()),"READ");
    hResPart[1] = (TH1D*)fileITSlt2Part->Get(Form("fHistPt%s",particle.Data()));
    TFile* fileITSlt2AntiPart  = TFile::Open(Form("files/Results-%s-13TeV-SPDClusters_000_100_V0M_000_100_FDUseMCRatio_ITS2GeV.root",
        antiparticle.Data()),"READ");
    hResAntiPart[1] = (TH1D*)fileITSlt2AntiPart->Get(Form("fHistPt%s",antiparticle.Data()));
    // TOF > 2 GeV/c
    TFile* fileTOFgt2Part  = TFile::Open(Form("files/Results-%s-13TeV-SPDClusters_000_100_V0M_000_100_FDUseMCRatio_TOF2GeV.root",
        particle.Data()),"READ");
    hResPart[2] = (TH1D*)fileTOFgt2Part->Get(Form("fHistPt%s",particle.Data()));
    TFile* fileTOFgt2AntiPart  = TFile::Open(Form("files/Results-%s-13TeV-SPDClusters_000_100_V0M_000_100_FDUseMCRatio_TOF2GeV.root",
        antiparticle.Data()),"READ");
    ...
    hMaxDev->SetStats(0);
    hMaxDev->GetYaxis()->SetTitle("#frac{max. rel. deviation (if > 1 #sigma_{RB})}{2} ");
