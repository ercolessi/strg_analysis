...
/***********************************************
  Cascade Analysis Module - Header
  -------------------------------
This version: 2021
--- Francesca Ercolessi
...
public:
  ...
  void SetMCDataFile        ( TString MCDataFilename0, TString MCDataFilename1, TString MCDataFilename2       );
  void SetOutputFile        ( TString OutputFilename       );
  void SetTOFpercFileName   ( TString TOFpercFilename  );
  void SetN0815percFileName ( TString percFilenameN0815 );
  ...
  void SetCutTOFBCIDNeg           (Double_t min, Double_t max);
  void SetCutTOFBCIDPos           (Double_t min, Double_t max);
  void SetCutTOFBCIDBach          (Double_t min, Double_t max);
  ...
  void SetCutTOFBCIDNeg           (TH1F* hCutMin, TH1F* hCutMax);
  void SetCutTOFBCIDPos           (TH1F* hCutMin, TH1F* hCutMax);
  void SetCutTOFBCIDBach          (TH1F* hCutMin, TH1F* hCutMax);
  ...
  //Set weights for efficiency calculation = number of events per dataset
  void SetEventsWeights( Double_t w0, Double_t w1, Double_t w2);
  ...
  Double_t GetCutMinTOFBCIDNeg        (Double_t pt);
  Double_t GetCutMaxTOFBCIDNeg        (Double_t pt);
  Double_t GetCutMinTOFBCIDPos        (Double_t pt);
  Double_t GetCutMaxTOFBCIDPos        (Double_t pt);
  Double_t GetCutMinTOFBCIDBach       (Double_t pt);
  Double_t GetCutMaxTOFBCIDBach       (Double_t pt);
  ...
  Bool_t CheckITSTOF ( ULong64_t lPosTrackStatus, ULong64_t lNegTrackStatus, ULong64_t lBachTrackStatus, Int_t lPosTOFBCID, Int_t lNegTOFBCID, Int_t lBachTOFBCID );
  ...
  void SetDoEfficiency(Bool_t DoIt);
...
private:
  ...
  TString fMCDataFile0;
  TString fMCDataFile1;
  TString fMCDataFile2;
  TString fOutputDataFile;
  TString fRapidityType;
  TString fTOFpercFilename;
  TString fpercFilenameN0815;

  Double_t fEventsWeights[3];

  Bool_t kDoEfficiency;
  ...
  Double_t fCutMinTOFBCIDNeg;
  Double_t fCutMaxTOFBCIDNeg;
  Double_t fCutMinTOFBCIDPos;
  Double_t fCutMaxTOFBCIDPos;
  Double_t fCutMinTOFBCIDBach;
  Double_t fCutMaxTOFBCIDBach;
  ...
  //--- TOF cuts
  TH1F* fHistCutMinTOFBCIDNeg;
  TH1F* fHistCutMaxTOFBCIDNeg;
  TH1F* fHistCutMinTOFBCIDPos;
  TH1F* fHistCutMaxTOFBCIDPos;
  TH1F* fHistCutMinTOFBCIDBach;
  TH1F* fHistCutMaxTOFBCIDBach;
  ...
  //Multiplicity and Eff Energy Estimators (default V0M and ZDC)
