    ...
    Double_t lFixedHi = 20.)
{
  ...
  TH1F *hCascRadius = ReturnMaxDev(inputfilename, fWhichParticle.Data(), "CascRadius", fWhichFixedEstimator, fWhichVarEstimator);
  TH1F *hNegToPV = ReturnMaxDev(inputfilename, fWhichParticle.Data(), "DCANegToPV", fWhichFixedEstimator, fWhichVarEstimator);
  TH1F *hPosToPV = ReturnMaxDev(inputfilename, fWhichParticle.Data(), "DCAPosToPV", fWhichFixedEstimator, fWhichVarEstimator);
  TH1F *hV0ToPV = ReturnMaxDev(inputfilename, fWhichParticle.Data(), "DCAV0ToPV", fWhichFixedEstimator, fWhichVarEstimator);
  TH1F *hBachToPV = ReturnMaxDev(inputfilename, fWhichParticle.Data(), "DCABachToPV", fWhichFixedEstimator, fWhichVarEstimator);
  TH1F *hV0Daught = ReturnMaxDev(inputfilename, fWhichParticle.Data(), "DCAV0Daughters", fWhichFixedEstimator, fWhichVarEstimator);
  TH1F *hCascDaught = ReturnMaxDev(inputfilename, fWhichParticle.Data(), "DCACascDaughters", fWhichFixedEstimator, fWhichVarEstimator);
  TH1F *hV0CosPA = ReturnMaxDev(inputfilename, fWhichParticle.Data(), "V0CosPA", fWhichFixedEstimator, fWhichVarEstimator);
  TH1F *hCascCosPA = ReturnMaxDev(inputfilename, fWhichParticle.Data(), "CascCosPA", fWhichFixedEstimator, fWhichVarEstimator);
  TH1F *hV0Mass = ReturnMaxDev(inputfilename, fWhichParticle.Data(), "V0Mass", fWhichFixedEstimator, fWhichVarEstimator);
  ...
  Top->SaveAs(Form("images/uncorr/fixed%s/TopologicalYieldsSystematics%s-%s%03.0f_%03.0f.png", fWhichFixedEstimator.Data(), fWhichParticle.Data(), fWhichFixedEstimator.Data(), lFixedLo, lFixedHi));
  ...
  l1->Draw("SAME");
  xlabel2->DrawLatex(0.6, 0.51, Form(" %s [%.0f-%.0f] points", fWhichFixedEstimator.Data(), lFixedLo, lFixedHi));
  xlabel->DrawLatex(0.8, 0.82, Form("#%s", fWhichParticle.Data()));

  Sel->SaveAs(Form("images/uncorr/fixed%s/YieldsSelectionSystematics%s-%s%03.0f_%03.0f.png", fWhichFixedEstimator.Data(), fWhichParticle.Data(), fWhichFixedEstimator.Data(), lFixedLo, lFixedHi));
  ...
  legend->Draw("SAME");
  xlabel2->DrawLatex(0.6, 0.61, Form(" %s [%.0f-%.0f] ", fWhichFixedEstimator.Data(), lFixedLo, lFixedHi));
  xlabel->DrawLatex(0.8, 0.82, Form("#%s", fWhichParticle.Data()));

  cn->SaveAs(Form("images/uncorr/fixed%s/YieldsSystematics-Displayed-%s-%s%03.0f_%03.0f.png", fWhichFixedEstimator.Data(), fWhichParticle.Data(), fWhichFixedEstimator.Data(), lFixedLo, lFixedHi));
  ...
  hSystTotNeg->Draw("E2");
  xlabel2->DrawLatex(0.6, 0.51, Form(" %s [%.0f-%.0f] ", fWhichFixedEstimator.Data(), lFixedLo, lFixedHi));

  cfinal->SaveAs(Form("images/uncorr/fixed%s/FinalYieldsSystContribPlot%s%s-%03.0f_%03.0f.png", fWhichFixedEstimator.Data(), fWhichParticle.Data(), fWhichFixedEstimator.Data(), lFixedLo, lFixedHi));
...
TH1F* ReturnMaxDev(
    ...
    hCutVarClone[0]->GetYaxis()->SetRangeUser(0.9,1.1);
...
double PassRogerBarlowCriterion(int nsigmas, TH1F* h, int bin){
  ...
  cout <<  (TMath::Abs(dev-1)) << "  " << RBsigma*nsigmas << endl;
  if( (TMath::Abs(dev-1)) > RBsigma*nsigmas ) cout << "true" << endl;
