void dosystomegaspd4050(){
    TFile* f = TFile::Open(Form("FinalSystematicsYield-%s-fixedSPDClusters_%03.0f_%03.0f.root","Omega",10., 20.));
    TH1F* h = (TH1F*)f->Get("hSystTot");
    h->Draw();

    Double_t perc[] = {0,10,30,50,100};
    const int n = 4;
    ...
    TFile* f1 = new TFile(Form("FinalSystematicsYield-%s-fixedSPDClusters_%03.0f_%03.0f.root","Omega",40., 50.),"RECREATE");
    hnew2->Write();
