...
void runCascAnalysis(
	...
	TString lWhichMultEstimator = "SPDClusters", // V0M / SPDClusters / TOF / NGlobaltrk0815 / SPDtrk0815
	TString lWhichEffEnergyEstimator = "V0M",	 // V0M / ZDC
	...
	Bool_t lSweepFlag = kFALSE)
{
	...
	if (lCascType.Contains("Xi"))
		lMCFilename0 = "/home/fercoles/strg_analysis/PhDWork/Data/LHC15g3b1.root";
	if (lCascType.Contains("Omega"))
		lMCFilename0 = "/home/fercoles/strg_analysis/PhDWork/Data/LHC15g3b2.root";
	TString lMCFilename1 = "/home/fercoles/strg_analysis/PhDWork/Data/LHC22e1_17jRunList.root";
	TString lMCFilename2 = "/home/fercoles/strg_analysis/PhDWork/Data/LHC22e1_18iRunList.root";
	...
	casc->SetMCDataFile(lMCFilename0.Data(), lMCFilename1.Data(), lMCFilename2.Data());
	// weights for efficiency
	Double_t w0 = 3.591657E+7;
	Double_t w1 = 2.984665E+7;
	Double_t w2 = 5.014868E+7;
	casc->SetEventsWeights(w0, w1, w2);
	...
	Double_t ptXi[] = {0.0, 1.0, 2.0, 4.0, 6.};
	//{0.6, 1.0, 1.2, 1.4, 1.6, 1.8, 2.0, 2.2, 2.5, 2.9, 3.4, 4.0, 5.0, 6.5};
  ...
  if (lWhichMultEstimator.Contains("0815")) casc->SetN0815percFileName ( lpercnameN0815.Data()  );
