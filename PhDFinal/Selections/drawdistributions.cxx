...
void drawdistributions(){
    ...
    for (int i = 0; i < size1; i++)
    {
        ...
        pnch_1[i]->GetYaxis()->SetRangeUser(-0.002, pnch_1[i]->GetMaximum() * 1.2);
    ...
    for (int i = 0; i < size1; i++)
    {
        pZN_1[i]->Rebin(15);
        histo(pZN_1[i]);
        pZN_1[i]->GetXaxis()->SetRangeUser(0, 1000);
    ...
    for (int i = 0; i < size1; i++)
    {
        ...
        ratiozn[i]->GetXaxis()->SetRangeUser(0, 1000);
    ...
    for (int i = 0; i < size3; i++)
    {
        ...
        pnch_3[i]->GetYaxis()->SetRangeUser(-0.001, 0.25);
...
void histo(TH1D* h){
    ...
    //h->GetYaxis()->SetRangeUser(-0.002, h->GetMaximum() * 1.2);
