void PrintYields(int nclass = 0){
    ...
    for (int i = 0; i < nsel; i++){
        fXi[i] = TFile::Open(Form("%sYields%s_June23.root", "Xi", sel[i].Data()));
        fLambda[i] = TFile::Open(Form("%sYields%s_June23.root", "Lambda", sel[i].Data()));
        fK0s[i] = TFile::Open(Form("%sYields%s_June23.root", "K0Short", sel[i].Data()));
    }
