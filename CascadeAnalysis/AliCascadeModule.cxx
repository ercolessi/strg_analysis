...
void AliCascadeModule::DoAnalysis(){
    ...
    TH1F* fHistReco           = new TH1F("fHistReco",           "Cascade generated from Levy-Tsallis Fit;p_{T} (GeV/c);Counts", 250, 0., 25.);
    ...
    for(Long_t iEv = 0; iEv<lTreeEvent->GetEntries(); iEv++) {
        ...
        if (fWhichMultEstimator.Contains("TOF")) fMultCentrality = GetTOFpercentile(Read, fTOFPads, fRun); 
    ...
    if(!fUsePeakPositionAndWidthFromFit) {
        ...
        for(Long_t icand = 0;icand<lNCandidates;icand++){
            ...
            if (fWhichMultEstimator.Contains("TOF")) lMultiplicity = GetTOFpercentile(Read, fTOFPads, fRun); 
    ...
    if (fWhichMultEstimator.Contains("SPD") || fWhichMultEstimator.Contains("V0M") )
        lTreeEventMC->SetBranchAddress(Form("fCentrality_%s",fWhichMultEstimator.Data()),   &fMultCentrality);
    if (fWhichMultEstimator.Contains("TOF") )
        lTreeEventMC->SetBranchAddress(Form("fCentrality_%s","SPDClusters"),   &fMultCentrality);
    ...
    if (fWhichMultEstimator.Contains("SPD") || fWhichMultEstimator.Contains("V0M"))lTreeMC->SetBranchAddress(Form("fTreeCascVarCentrality_%s",fWhichMultEstimator.Data()),   &fMultCentrality);
    if (fWhichMultEstimator.Contains("TOF") )lTreeMC->SetBranchAddress(Form("fTreeCascVarCentrality_%s","SPDClusters"),   &fMultCentrality);
    ...
    for(Long_t icand = 0;icand<lNCandidatesMC;icand++){
        ...
        lWeAreAtBin_pTCorr = fHistReco->FindBin( lPt ) - 1;
        if(lWeAreAtBin_pTCorr == -1) lWeAreAtBin = 250; //UnderFlow, special treatment
        ...
        if(fSaveVarHistosSwitch) {
            ...
            if(lInvariantMass>lPeakLeftLimitMC[lWeAreAtBin] && lInvariantMass<lPeakRightLimitMC[lWeAreAtBin]) {
                ...
                lHistSigPlusCenterBgMCAll[ NEGTOFBCID    ] -> Fill( lPt, lNegTOFBCID );
                lHistSigPlusCenterBgMCAll[ POSTOFBCID    ] -> Fill( lPt, lPosTOFBCID );
                lHistSigPlusCenterBgMCAll[ BACHTOFBCID   ] -> Fill( lPt, lBachTOFBCID );
            ...
            if( (lInvariantMass>lLeftBgLeftLimitMC[lWeAreAtBin]  && lInvariantMass<lLeftBgRightLimitMC[lWeAreAtBin]  ) ||
                ...
                lHistLeftPlusRightBgMCAll[ NEGTOFBCID    ] -> Fill( lPt, lNegTOFBCID );
                lHistLeftPlusRightBgMCAll[ POSTOFBCID    ] -> Fill( lPt, lPosTOFBCID );
                lHistLeftPlusRightBgMCAll[ BACHTOFBCID   ] -> Fill( lPt, lBachTOFBCID );
            ...
            if( ( fWhichParticle    == "XiMinus"
                ...
                if(lInvariantMass>lPeakLeftLimitMC[lWeAreAtBin] && lInvariantMass<lPeakRightLimitMC[lWeAreAtBin]) {
                    ...
                    lHistSigPlusCenterBgMCAssAll[ NEGTOFBCID    ] -> Fill( lPt, lNegTOFBCID );
                    lHistSigPlusCenterBgMCAssAll[ POSTOFBCID    ] -> Fill( lPt, lPosTOFBCID );
                    lHistSigPlusCenterBgMCAssAll[ BACHTOFBCID   ] -> Fill( lPt, lBachTOFBCID );
                ...
                if( (lInvariantMass>lLeftBgLeftLimitMC[lWeAreAtBin]  && lInvariantMass<lLeftBgRightLimitMC[lWeAreAtBin]  ) ||
                    ...
                    lHistLeftPlusRightBgMCAssAll[ NEGTOFBCID    ] -> Fill( lPt, lNegTOFBCID );
                    lHistLeftPlusRightBgMCAssAll[ POSTOFBCID    ] -> Fill( lPt, lPosTOFBCID );
                    lHistLeftPlusRightBgMCAssAll[ BACHTOFBCID   ] -> Fill( lPt, lBachTOFBCID );
        ...
        if( lRap<fRapidityBoundaryUpper && lRap>fRapidityBoundaryLower &&
            ...
            if(fSaveVarHistosSwitch) {
                ...
                if( lInvariantMass>lPeakLeftLimitMC[lWeAreAtBin] && lInvariantMass<lPeakRightLimitMC[lWeAreAtBin] ) {
                    ...
                    lHistSigPlusCenterBgMCSel[ NEGTOFBCID    ] -> Fill( lPt, lNegTOFBCID );
                    lHistSigPlusCenterBgMCSel[ POSTOFBCID    ] -> Fill( lPt, lPosTOFBCID );
                    lHistSigPlusCenterBgMCSel[ BACHTOFBCID   ] -> Fill( lPt, lBachTOFBCID );
                ...
                if( (lInvariantMass>lLeftBgLeftLimitMC[lWeAreAtBin]  && lInvariantMass<lLeftBgRightLimitMC[lWeAreAtBin]  ) ||
                    ...
                    lHistLeftPlusRightBgMCSel[ NEGTOFBCID    ] -> Fill( lPt, lNegTOFBCID );
                    lHistLeftPlusRightBgMCSel[ POSTOFBCID    ] -> Fill( lPt, lPosTOFBCID );
                    lHistLeftPlusRightBgMCSel[ BACHTOFBCID   ] -> Fill( lPt, lBachTOFBCID );
            ...
            if( ( fWhichParticle    == "XiMinus"
                ...
                if(fSaveVarHistosSwitch) {
                    ...
                    if(lInvariantMass>lPeakLeftLimitMC[lWeAreAtBin] && lInvariantMass<lPeakRightLimitMC[lWeAreAtBin]) {
                        ...
                        lHistSigPlusCenterBgMCAssSel[ NEGTOFBCID    ] -> Fill( lPt, lNegTOFBCID );
                        lHistSigPlusCenterBgMCAssSel[ POSTOFBCID    ] -> Fill( lPt, lPosTOFBCID );
                        lHistSigPlusCenterBgMCAssSel[ BACHTOFBCID   ] -> Fill( lPt, lBachTOFBCID );
                    ...
                    if( (lInvariantMass>lLeftBgLeftLimit[lWeAreAtBin]  && lInvariantMass<lLeftBgRightLimit[lWeAreAtBin]  ) ||
                        ...
                        lHistLeftPlusRightBgMCAssSel[ NEGTOFBCID    ] -> Fill( lPt, lNegTOFBCID );
                        lHistLeftPlusRightBgMCAssSel[ POSTOFBCID    ] -> Fill( lPt, lPosTOFBCID );
                        lHistLeftPlusRightBgMCAssSel[ BACHTOFBCID   ] -> Fill( lPt, lBachTOFBCID );
    ...
    for(Int_t ipoint = 0; ipoint<250; ipoint++){
      //MC pT Corr
        ...
        fHistReco->SetBinContent(ipoint+1, lSigMCCasc_pTCorr[ipoint]);
    }
