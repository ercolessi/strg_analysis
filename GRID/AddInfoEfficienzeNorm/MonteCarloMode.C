...
void MonteCarloMode(Int_t Period)
  
{
  ...
  //AliAnalysisTask* fw = AddTaskForwardMult(kTRUE);
...
wv->SetV0VertexerDCAV0Daughters(2.0); //1.40
...
wv->SetCascVertexerV0MassWindow(0.01); // very loose
wv->SetCascVertexerDCABachToPV(0.03); //0.05
wv->SetCascVertexerDCACascadeDaughters(2.0); //1.4
wv->SetCascVertexerCascadeMinRadius(.3); // min value Omega //0.5
wv->SetCascVertexerCascadeCosinePA(.95);

  
  //Strangness Task
  gROOT->LoadMacro("/alistorage/fercolessi/testGRID/AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22.cxx++g");
  gROOT->LoadMacro("/alistorage/fercolessi/testGRID/AddTaskStrangenessVsMultiplicityEEMCRun22.C");
  AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22* st = AddTaskStrangenessVsMultiplicityEEMCRun22(kTRUE,kTRUE,kTRUE,"ABC");
  st->SetDownScaleEvent(kFALSE, 1.0000);
  st->SetDownScaleV0(kFALSE, 1.0000);
  st->SetDownScaleCascade(kFALSE, 1.0000);
  st->SetRunVertexers(kTRUE);  
  ...
  if (grid)
    {
      ...
      alienHandler->SetAdditionalLibs("AliAnalysisTaskWeakDecayVertexer.cxx AliAnalysisTaskWeakDecayVertexer.h AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22.cxx AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22.h");
      alienHandler->SetAnalysisSource("AliAnalysisTaskWeakDecayVertexer.cxx AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22.cxx");
	...
	alienHandler->SetGridDataDir("/alice/sim/2015/LHC15g3c3/");
	...
	alienHandler->SetGridWorkingDir("testZDC/noR2Dcut");
      }
          
	//LHC17j
	if (Period==17){

        alienHandler->SetGridDataDir("/alice/sim/2017/LHC17h11_extra/");
        //alienHandler->SetRunPrefix("000");
        alienHandler->SetDataPattern("/*/AliESDs.root");
        // runnumber
        ...
        alienHandler->SetGridWorkingDir("testZDC/LHC17j");
      }
	 ...
	 alienHandler->SetGridDataDir("/alice/sim/2020/LHC20i2a/");
	 //alienHandler->SetRunPrefix("000");
	 alienHandler->SetDataPattern("/*/AliESDs.root");
	 // runnumber
	 ...
	 alienHandler->SetGridWorkingDir("testZDC/LHC18i");
       }                 
