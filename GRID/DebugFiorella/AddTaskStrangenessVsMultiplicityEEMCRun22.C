AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22 *AddTaskStrangenessVsMultiplicityEEMCRun22( Bool_t lSaveEventTree = kTRUE, Bool_t lSaveV0 = kTRUE, Bool_t lSaveCascade = kTRUE, TString lExtraOptions = "", const TString lMasterJobSessionFlag = "", TString lExtraOutputName = "")
{
    ...
    AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22 *taskAuxiliary = new AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22(kTRUE, kTRUE, kTRUE, Form("taskAuxiliary%s",lExtraOutputName.Data()), lExtraOptions);
