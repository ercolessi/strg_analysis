...
////////////////////////////////////////////////////////////////////////////////////
//                                                                                //
// Macro to run Fiorella's analysis vs multiplicity on grid                       //
  ...
  
{
  ...
  AliPhysicsSelectionTask* ps = AddTaskPhysicsSelection(kFALSE);
  ...
  //Strangness Task
  gROOT->LoadMacro("$ALICE_PHYSICS/PWGLF/STRANGENESS/Cascades/macros/AddTaskStrangenessVsMultiplicity.C");
  AliAnalysisTaskStrangenessVsMultiplicity* st = AddTaskStrangenessVsMultiplicity();
  ...
  st->SetUseMultSelection(kTRUE);
  st->SetMininumBiasAnalysis(kTRUE);
  ...
  if (grid)
    {
      ...
      alienHandler->SetAliPhysicsVersion("vAN-20181125-1");   
      ...
      for (Int_t i= 1;i <2; i++) alienHandler->AddRunNumber(runList[i]);
        
      alienHandler->SetGridWorkingDir("NewEventSelection/FiorLHC15f/");
