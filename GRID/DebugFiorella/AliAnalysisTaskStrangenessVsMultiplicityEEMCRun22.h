...
#ifndef AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22_H
#define AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22_H
...
class AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22 : public AliAnalysisTaskSE {
public:
    AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22();
    AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22(Bool_t lSaveEventTree, Bool_t lSaveV0Tree, Bool_t lSaveCascadeTree, const char *name, TString lExtraOptions = "");
    virtual ~AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22();
...
private:
    ...
    //ZDC info for effective energy study
    Float_t fZNApp;//!
    Float_t fZNCpp;//!
    Float_t fZPApp;//!
    Float_t fZPCpp;//!
    ...
    Bool_t fTreeVariableEvSel_INELgtZERO; //!
    ...
    Bool_t fTreeCascVarEvSel_INELgtZERO; //!    
    ...
    AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22(const AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22&);            // not implemented
    AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22& operator=(const AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22&); // not implemented
    
    ClassDef(AliAnalysisTaskStrangenessVsMultiplicityEEMCRun22, 1);
