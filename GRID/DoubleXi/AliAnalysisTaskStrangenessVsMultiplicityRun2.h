...
//===========================================================================================
    ...
    Bool_t  fEvSel_kINT7Trigger; //!
    Bool_t  fEvSel_kMBTrigger; //!
...
//===========================================================================================
    //Selection
    Int_t fTreeCascVarNCascades; //!
    Bool_t  fTreeCascVarEvSel_INELgtZERO; //!
    Bool_t  fTreeCascVarEvSel_kINT7Trigger; //!
    Bool_t  fTreeCascVarEvSel_kMBTrigger; //!
    Bool_t  fTreeCascVarEvSel_zVtxZMC; //!
    Bool_t  fTreeCascVarEvSel_AcceptedVertexPosition; //!
    Bool_t  fTreeCascVarEvSel_NotIncDAQ; //!
    Bool_t  fTreeCascVarEvSel_NotPileupSPDInMultBins; //!
    Bool_t  fTreeCascVarEvSel_NoInconsSPDandTrackVrtx; //!
    Bool_t  fTreeCascVarEvSel_PassSPDClsVsTrackletsCut; //!
