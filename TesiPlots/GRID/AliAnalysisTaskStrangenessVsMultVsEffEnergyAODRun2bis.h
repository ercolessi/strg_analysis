...
#ifndef AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2bis_H
#define AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2bis_H
...
class AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2bis : public AliAnalysisTaskSE {
public:
    AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2bis();
    AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2bis(Bool_t lSaveEventTree, Bool_t lSaveV0Tree, Bool_t lSaveCascadeTree, const char *name, TString lExtraOptions = "");
    virtual ~AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2bis();
...
private:
    ...
    AliESDtrackCuts *fESDtrackCutsStandardITSTPC2011pp; //! ESD track cuts used for global track definition
...
//===========================================================================================
    ...
    AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2bis(const AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2bis&);            // not implemented
    AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2bis& operator=(const AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2bis&); // not implemented

    ClassDef(AliAnalysisTaskStrangenessVsMultVsEffEnergyAODRun2bis, 1);
