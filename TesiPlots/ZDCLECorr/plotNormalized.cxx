...
void plotNormalized()
{
    ...
    TH1D *hframe = new TH1D("hframe", ";Leading Energy / #LT Leading Energy #GT_{INEL>0}; ZN / #LT ZN #GT_{INEL>0}", 100, 0, 2);
    ...
    Float_t ZNv0m_1_MB;
    Float_t ErrZNv0m_1_MB;
    Float_t LEv0m_1_MB;
    Float_t ErrLEv0m_1_MB;
    TH1F* hLEv0m_1[nbins];
    TH1F *hZNv0m_1[nbins];
    TH1F *hLEspd_1[nbins];
    TH1F *hZNspd_1[nbins];
    TH1F *hLEv0m_1_MB =new TH1F(Form("hLEv0m_1_MB"), ";Leading Energy (GeV)", 200, 0, 13000);
    TH1F *hZNv0m_1_MB =new TH1F(Form("hZNv0m_1_MB"), ";Leading Energy (GeV)", 200, 0, 13000);
    ...
    for (Long_t iEv = 0; iEv < lt1->GetEntries()/100; iEv++)
    {
        ...
        hLEv0m_1_MB->Fill(TMath::Abs(lt1->GetLeaf("effEnergy")->GetValue()));
        hZNv0m_1_MB->Fill(adcZDCN1 + adcZDCN2);
    ...
    ZNv0m_1_MB = hZNv0m_1_MB->GetMean();
    LEv0m_1_MB = hLEv0m_1_MB->GetMean();
    ErrZNv0m_1_MB = hZNv0m_1_MB->GetMeanError();
    ErrLEv0m_1_MB = hLEv0m_1_MB->GetMeanError();

    for (int i = 0; i < nbins; i++)
    {
        ZNv0m_1[i] = hZNv0m_1[i]->GetMean()/ZNv0m_1_MB;
        LEv0m_1[i] = hLEv0m_1[i]->GetMean()/LEv0m_1_MB;
        ErrZNv0m_1[i] = hZNv0m_1[i]->GetMeanError()/ZNv0m_1_MB;
        ErrLEv0m_1[i] = hLEv0m_1[i]->GetMeanError()/LEv0m_1_MB;
        ZNspd_1[i] = hZNspd_1[i]->GetMean()/ZNv0m_1_MB;
        LEspd_1[i] = hLEspd_1[i]->GetMean()/LEv0m_1_MB;
        ErrZNspd_1[i] = hZNspd_1[i]->GetMeanError()/ZNv0m_1_MB;
        ErrLEspd_1[i] = hLEspd_1[i]->GetMeanError()/LEv0m_1_MB;
    }
    ...
    Float_t ZNv0m_2_MB;
    Float_t ErrZNv0m_2_MB;
    Float_t LEv0m_2_MB;
    Float_t ErrLEv0m_2_MB;
    TH1F *hLEv0m_2[nbins];
    TH1F *hZNv0m_2[nbins];
    TH1F *hLEspd_2[nbins];
    TH1F *hZNspd_2[nbins];
    TH1F *hLEv0m_2_MB = new TH1F(Form("hLEv0m_2_MB"), ";Leading Energy (GeV)", 200, 0, 13000);
    TH1F *hZNv0m_2_MB = new TH1F(Form("hZNv0m_2_MB"), ";Leading Energy (GeV)", 200, 0, 13000);
    ...
    for (Long_t iEv = 0; iEv < lt2->GetEntries() / 100; iEv++)
    {
        ...
        hLEv0m_2_MB->Fill(TMath::Abs(lt1->GetLeaf("effEnergy")->GetValue()));
        hZNv0m_2_MB->Fill(adcZDCN1 + adcZDCN2);
    ...
    ZNv0m_2_MB = hZNv0m_2_MB->GetMean();
    LEv0m_2_MB = hLEv0m_2_MB->GetMean();
    ErrZNv0m_2_MB = hZNv0m_2_MB->GetMeanError();
    ErrLEv0m_2_MB = hLEv0m_2_MB->GetMeanError();

    for (int i = 0; i < nbins; i++)
    {
        ZNv0m_2[i] = hZNv0m_2[i]->GetMean()/ZNv0m_2_MB;
        LEv0m_2[i] = hLEv0m_2[i]->GetMean()/LEv0m_2_MB;
        ErrZNv0m_2[i] = hZNv0m_2[i]->GetMeanError()/ZNv0m_2_MB;
        ErrLEv0m_2[i] = hLEv0m_2[i]->GetMeanError()/LEv0m_2_MB;
        ZNspd_2[i] = hZNspd_2[i]->GetMean()/ZNv0m_2_MB;
        LEspd_2[i] = hLEspd_2[i]->GetMean()/LEv0m_2_MB;
        ErrZNspd_2[i] = hZNspd_2[i]->GetMeanError()/ZNv0m_2_MB;
        ErrLEspd_2[i] = hLEspd_2[i]->GetMeanError()/LEv0m_2_MB;
    }
    ...
    TH1F *hZNspd_3[nbins];
    Float_t ZNv0m_3_MB;
    Float_t ErrZNv0m_3_MB;
    Float_t LEv0m_3_MB;
    Float_t ErrLEv0m_3_MB;
    TH1F *hLEv0m_3_MB = new TH1F(Form("hLEv0m_3_MB"), ";Leading Energy (GeV)", 200, 0, 13000);
    TH1F *hZNv0m_3_MB = new TH1F(Form("hZNv0m_3_MB"), ";Leading Energy (GeV)", 200, 0, 13000);
    ...
    for (Long_t iEv = 0; iEv < lt3->GetEntries() / 100; iEv++)
    {
        ...
        hLEv0m_3_MB->Fill(TMath::Abs(lt1->GetLeaf("effEnergy")->GetValue()));
        hZNv0m_3_MB->Fill(adcZDCN1 + adcZDCN2);
    ...
    ZNv0m_3_MB = hZNv0m_3_MB->GetMean();
    LEv0m_3_MB = hLEv0m_3_MB->GetMean();
    ErrZNv0m_3_MB = hZNv0m_3_MB->GetMeanError();
    ErrLEv0m_3_MB = hLEv0m_3_MB->GetMeanError();

    for (int i = 0; i < nbins; i++)
    {
        ZNv0m_3[i] = hZNv0m_3[i]->GetMean()/ZNv0m_3_MB;
        LEv0m_3[i] = hLEv0m_3[i]->GetMean()/LEv0m_3_MB;
        ErrZNv0m_3[i] = hZNv0m_3[i]->GetMeanError()/ZNv0m_3_MB;
        ErrLEv0m_3[i] = hLEv0m_3[i]->GetMeanError()/LEv0m_3_MB;
        ZNspd_3[i] = hZNspd_3[i]->GetMean()/ZNv0m_3_MB;
        LEspd_3[i] = hLEspd_3[i]->GetMean()/LEv0m_3_MB;
        ErrZNspd_3[i] = hZNspd_3[i]->GetMeanError()/ZNv0m_3_MB;
        ErrLEspd_3[i] = hLEspd_3[i]->GetMeanError()/LEv0m_3_MB;
    }
    ...
    TH1F *hZNspd_4[nbins];
    Float_t ZNv0m_4_MB;
    Float_t ErrZNv0m_4_MB;
    Float_t LEv0m_4_MB;
    Float_t ErrLEv0m_4_MB;
    TH1F *hLEv0m_4_MB = new TH1F(Form("hLEv0m_4_MB"), ";Leading Energy (GeV)", 200, 0, 13000);
    TH1F *hZNv0m_4_MB = new TH1F(Form("hZNv0m_4_MB"), ";Leading Energy (GeV)", 200, 0, 13000);
    ...
    for (Long_t iEv = 0; iEv < lt4->GetEntries() / 100; iEv++)
    {
        ...
        hLEv0m_4_MB->Fill(TMath::Abs(lt1->GetLeaf("effEnergy")->GetValue()));
        hZNv0m_4_MB->Fill(adcZDCN1 + adcZDCN2);
    ...
    ZNv0m_4_MB = hZNv0m_4_MB->GetMean();
    LEv0m_4_MB = hLEv0m_4_MB->GetMean();
    ErrZNv0m_4_MB = hZNv0m_4_MB->GetMeanError();
    ErrLEv0m_4_MB = hLEv0m_4_MB->GetMeanError();

    for (int i = 0; i < nbins; i++)
    {
        ZNv0m_4[i] = hZNv0m_4[i]->GetMean()/ZNv0m_4_MB;
        LEv0m_4[i] = hLEv0m_4[i]->GetMean()/LEv0m_4_MB;
        ErrZNv0m_4[i] = hZNv0m_4[i]->GetMeanError()/ZNv0m_4_MB;
        ErrLEv0m_4[i] = hLEv0m_4[i]->GetMeanError()/LEv0m_4_MB;
        ZNspd_4[i] = hZNspd_4[i]->GetMean()/ZNv0m_4_MB;
        LEspd_4[i] = hLEspd_4[i]->GetMean()/LEv0m_4_MB;
        ErrZNspd_4[i] = hZNspd_4[i]->GetMeanError()/ZNv0m_4_MB;
        ErrLEspd_4[i] = hLEspd_4[i]->GetMeanError()/LEv0m_4_MB;
    }
