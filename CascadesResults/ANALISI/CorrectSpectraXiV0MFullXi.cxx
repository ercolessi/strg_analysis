...
void CorrectSpectraXiV0MFullXi(TString Type = "XiMinus", TString caso = "normal"){
//LASCIARE XIMINUS PERCHE' LE EFFCIENZE DI SGN LOSS FUNZIONANO SOLO COS^ RICORDA DI CAMBIARE
  const int nbins = 11;
	Double_t centrality[nbins] = {0.,1.,5.,10.,15.,20.,30.,40.,50.,70.,100.};
  
  // Get corrections
  TFile* file = new TFile("NormalizationCorrections/EventCountLoss_15g3c3.root","READ");
   // Get corrections
  TFile* filesgn = new TFile("NormalizationCorrections/EventCountLoss_15g3c3.root","READ");
  ...
  TFile* filename = TFile::Open(Form("../CLEAN/NewMcpTCorr/%sMCptshape%sIT%i_V0M_%03.0f_%03.0f_ZDC_%03.0f_%03.0f.root","Xi","V0M",3,0.,100.,lLoEE, lHiEE), "READ");
