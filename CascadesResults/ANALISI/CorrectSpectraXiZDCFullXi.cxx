...
void CorrectSpectraXiZDCFullXi(TString Type = "XiMinus", TString caso = "High"){
  ...
  // Get corrections
  TFile* file = new TFile("NormalizationCorrections/EventCountLoss_16d3.root","READ");
   // Get corrections
  TFile* filesgn = new TFile("NormalizationCorrections/EventCountLoss_16d3.root","READ");
