...
TH1 *YieldMean(TH1 *hstat, TF1 *f = NULL, Double_t min = 0., Double_t max = 10., Double_t loprecision = 0.01, Double_t hiprecision = 0.1, Option_t *opt = "0q",TString logfilename="log.root",Double_t minfit=0.0,Double_t maxfit=10.0);
...
void DoYieldsSystematicsMB(
  ...
  Double_t percentileV0[] = {0.,10,30,100};
  ...
  TString outputfilename = Form("Systematics-Yield-%s-%s-sel-V0M_%03.0f_%03.0f_ZDC_%03.0f_%03.0f.root","Xi","MB",lLoMult,lHiMult,lLoEE,lHiEE);

  // MB
  TH1F* hV0RadiusMB = ComputeYieldsforSystematics(outputfilename,"MB",fWhichParticle.Data(),lLoMult,lHiMult,lLoEE,lHiEE,"V0Radius");
  TH1F* hCascRadiusMB = ComputeYieldsforSystematics(outputfilename,"MB",fWhichParticle.Data(),lLoMult,lHiMult,lLoEE,lHiEE,"CascRadius");
  TH1F* hNegToPVMB = ComputeYieldsforSystematics(outputfilename,"MB",fWhichParticle.Data(),lLoMult,lHiMult,lLoEE,lHiEE,"DCANegToPV");
  TH1F* hPosToPVMB = ComputeYieldsforSystematics(outputfilename,"MB",fWhichParticle.Data(),lLoMult,lHiMult,lLoEE,lHiEE,"DCAPosToPV");
  TH1F* hV0ToPVMB = ComputeYieldsforSystematics(outputfilename,"MB",fWhichParticle.Data(),lLoMult,lHiMult,lLoEE,lHiEE,"DCAV0ToPV");
  TH1F* hBachToPVMB = ComputeYieldsforSystematics(outputfilename,"MB",fWhichParticle.Data(),lLoMult,lHiMult,lLoEE,lHiEE,"DCABachToPV");
  TH1F* hV0DaughtMB = ComputeYieldsforSystematics(outputfilename,"MB",fWhichParticle.Data(),lLoMult,lHiMult,lLoEE,lHiEE,"DCAV0Daughters");
  TH1F* hCascDaughtMB= ComputeYieldsforSystematics(outputfilename,"MB",fWhichParticle.Data(),lLoMult,lHiMult,lLoEE,lHiEE,"DCACascDaughters");
  TH1F* hV0CosPAMB = ComputeYieldsforSystematics(outputfilename,"MB",fWhichParticle.Data(),lLoMult,lHiMult,lLoEE,lHiEE,"V0CosPA");
  TH1F* hCascCosPAMB = ComputeYieldsforSystematics(outputfilename,"MB",fWhichParticle.Data(),lLoMult,lHiMult,lLoEE,lHiEE,"CascCosPA");
  TH1F* hV0MassMB = ComputeYieldsforSystematics(outputfilename,"MB",fWhichParticle.Data(),lLoMult,lHiMult,lLoEE,lHiEE,"V0Mass");
  TH1F* hCompetingSpeciesMB = 0x0;
  TH1F* hPLTMB = ComputeYieldsforSystematics(outputfilename,"MB",fWhichParticle.Data(),lLoMult,lHiMult,lLoEE,lHiEE,"ProperLifetime");
  TH1F* hTPCNSigmasMB = ComputeYieldsforSystematics(outputfilename,"MB",fWhichParticle.Data(),lLoMult,lHiMult,lLoEE,lHiEE,"TPCPIDNSigmas");
  TH1F* hTPCNClustersMB = ComputeYieldsforSystematics(outputfilename,"MB",fWhichParticle.Data(),lLoMult,lHiMult,lLoEE,lHiEE,"TPCNClusters");
  TH1F* hSigExtBinCountMB = ComputeYieldsforSystematics(outputfilename,"MB",fWhichParticle.Data(),lLoMult,lHiMult,lLoEE,lHiEE,"SigExtBinCount");
  TH1F* hGeantFlukaMB = ComputeYieldsforSystematics(outputfilename,"MB",fWhichParticle.Data(),lLoMult,lHiMult,lLoEE,lHiEE,"GeantFlukaCorrection");
  ...
  hPLTMB->Write();
  hV0MassMB->Write();
  hTPCNClustersMB->Write();
  hTPCNSigmasMB->Write();
  hSigExtBinCountMB->Write();
  hGeantFlukaMB->Write();
}
...
TH1F* ComputeYieldsforSystematics(
  ...
  TString lWhichSystVar = "V0Radius") {
    ...
    for (int i = 0; i < binnumber; i++){ //loop over selection classes           
      ...
      //
      TString lSystFile = "../../CLEAN/sistematiche/CLEAN/Results/Results-Systematics";
      lSystFile.Append( Form( "-%s-13TeV-V0M_%03.0f_%03.0f_ZDC_%03.0f_%03.0f-", fWhichParticle.Data(), v0min, v0max, zdcmin, zdcmax) );
      TString lAntiSystFile = "../../CLEAN/sistematiche/CLEAN/Results/Results-Systematics";
      lAntiSystFile.Append( Form( "-%s-13TeV-V0M_%03.0f_%03.0f_ZDC_%03.0f_%03.0f-", fWhichAntiParticle.Data(), v0min, v0max, zdcmin, zdcmax) );
      //
      lResultsFile[i][0] = TFile::Open(Form( "../../CLEAN/sistematiche/CLEAN/Results/Results-%s-13TeV-V0M_%03.0f_%03.0f_ZDC_%03.0f_%03.0f.root", fWhichParticle.Data(), v0min, v0max, zdcmin, zdcmax));
      lAntiResultsFile[i][0] = TFile::Open(Form( "../../CLEAN/sistematiche/CLEAN/Results/Results-%s-13TeV-V0M_%03.0f_%03.0f_ZDC_%03.0f_%03.0f.root", fWhichAntiParticle.Data(), v0min, v0max, zdcmin, zdcmax));
      for (int j = 1; j < 5; j++){
        //Particle
    ...
    hMaxDev->Draw();
    maxdev->SaveAs(Form("images/yields/MB/Yields-%s-MaxRelDev%s-%s.png",fWhichParticle.Data(),lWhichSystVar.Data(),fWhichEstimator.Data()));
    ...
    for (int k = 1; k < 5; k++){
      ...
      hYield[k]->SetYTitle("dN/dy^{syst-cut} / dN/dy^{def-cut}");
    ...
    legend->Draw("SAME");    
    cutvar->SaveAs(Form("images/yields/MB/Yields-%s-CutVar-%s-%s.png",fWhichParticle.Data(),lWhichSystVar.Data(),fWhichEstimator.Data()));
...
//--------------------------------------------------------------------------------------------
TH1 *
YieldMean(TH1 *hstat, TF1 *f = NULL, Double_t min = 0., Double_t max = 10., Double_t loprecision = 0.01, Double_t hiprecision = 0.1, Option_t *opt = "0q",TString logfilename="log.root",Double_t minfit=0.8,Double_t maxfit=8.0)
{
  if(maxfit>max)
    max=maxfit; 
  if(minfit<min)
