...
void AliCascadeModule::SetZDCtoEEFileName ( TString ZDCtoEEFile ) {
	//Set root file containing effective energy information
	fZDCtoEEFile = ZDCtoEEFile;
}
...
void AliCascadeModule::PrintConfiguration() {
    ...
    cout<<" Effective Energy file..........: "<<fZDCtoEEFile<<endl;
    cout<<"--------------------------------------------------------"<<endl;
    cout<<endl;
}
...
void AliCascadeModule::DoAnalysis(){
    ...
    TFile* Read = new TFile (fZDCtoEEFile);
    cout<<"--------------------------------------------------------"<<endl;
    ...
    for(Long_t icand = 0;icand<lNCandidates;icand++){
        ...
        if (fPerformEEStudy && (lCascZDCPercentile<lLoEEBound || lCascZDCPercentile>lHiEEBound) ) continue;
