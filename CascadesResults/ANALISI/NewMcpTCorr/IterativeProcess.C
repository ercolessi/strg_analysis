...
//------------------- MAIN FUNCTION ----------------------------
//--------------------------------------------------------------
void IterativeProcess(int iteration = 3, TString fWhichEstimator = "ZDC", Double_t lLoMult = 0., Double_t lHiMult = 30., 
...
//++++++++++++++++++++++++++++++++++++++++ 
    ...
    if (fWhichEstimator.Contains("V0M")) Levy[9] = LevyTsallis(Form("Levy%s_V0M_%03.0f_%03.0f_ZDC_%03.0f_%03.0f",fWhichParticle.Data(),mult[9],mult[9+1],lLoEE,lHiEE), 1.32131 ,1e-3,1e+2,1e-6,1e+6);
    ...
    for(int nmult = 0; nmult < multbinnumb; nmult++)
    {
        ...
        LevyMCMB[nmult] = LevyTsallis(Form("LevyMC%s_%.0f_%.0f%i",fWhichParticle.Data(),0.,100.,nmult), 1.32131, 1e-2,1e+3,1e-6,1e+6);
       //Sum
