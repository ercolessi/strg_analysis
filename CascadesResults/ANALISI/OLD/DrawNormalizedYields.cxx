...
void DrawNormalizedYields(){
  ...
  //  TFile* fileV0  = TFile::Open("TestfullfitYield-Xi-V0M-V0M_000_100_ZDC_000_100.root","READ");
   ...
   //
    ...
    TCanvas* EE = new TCanvas("EE", "", 1600,1300);
    ...
    g->GetYaxis()->SetRangeUser(0.2,1.8);
    g->SetTitle("");
    g->Draw();
    ...
    hHighMultSyst ->SetLineColor(kMagenta+2);
    hHighMultSyst ->SetLineWidth(1);
    hHighMultStat ->SetLineColor(kMagenta+2);
    hHighMultStat ->SetMarkerColor(kMagenta+2);
    hHighMultStat ->SetMarkerStyle(kOpenCircle);
    hHighMultStat ->SetMarkerSize(2.9);
    hLowMultStat ->SetMarkerColor(kGreen+3);
    hLowMultStat ->SetLineColor(kGreen+3);
    hLowMultStat ->SetMarkerStyle(kFullCircle);
    hLowMultSyst ->SetLineColor(kGreen+3+1);
    hLowMultSyst ->SetFillColor(kGreen-8);
    hLowMultSyst ->SetFillStyle(0);
    hLowMultStat ->SetMarkerSize(2.9);
    hLowMultSyst ->SetMarkerSize(2.9);
    hLowMultSyst ->SetMarkerStyle(kFullCircle);
    hLowMultSyst ->SetMarkerColor(kGreen+3);
    hHighMultSyst ->SetMarkerSize(2.9);
    hHighMultSyst ->SetMarkerStyle(kOpenCircle);

    hHighMultSyst ->SetMarkerColor(kMagenta+2);
    ...
    l2->SetBorderSize(0);
    l2->SetHeader("Multiplicity selection:","NDF");
    l2->AddEntry(hHighMultSyst ,"V0M 0-30%, high multiplicity","P");
    l2->AddEntry(hLowMultSyst ,"V0M 70-100%, low multiplicity","P");
    ...
    texbr->SetTextSize(0.02808798);
   // texb->SetLineWidth(2);
    texbr->Draw("SAME");
    texbbr->SetTextSize(0.02808798);
   // texb->SetLineWidth(2);
    texbbr->Draw("SAME");
    ...
    TCanvas* Mult = new TCanvas("Mult", "", 1600,1300);
    //Mult->SetGridy();
    Mult->SetFillColor(kWhite);

    TH1D* ga = new TH1D("g", " ", 12, -5., 105.);
    ...
    ga->GetYaxis()->SetRangeUser(0.2,1.8);
    ga->SetTitle("");
    ga->Draw();
    ...
    hHighEESyst ->SetLineColor(kOrange+10);
    hHighEESyst ->SetLineWidth(1);
    hHighEEStat ->SetLineColor(kOrange+10);
    hHighEEStat ->SetMarkerColor(kOrange+10);
    hHighEEStat ->SetMarkerStyle(25);
    hHighEEStat ->SetMarkerSize(2.7);
    hLowEEStat ->SetMarkerColor(kBlue+1);
    hLowEEStat ->SetLineColor(kBlue+1);
    hLowEEStat ->SetMarkerStyle(21);
    hLowEESyst ->SetLineColor(kBlue+1);
    hLowEESyst ->SetFillColor(kBlue+1);
    hLowEESyst ->SetFillStyle(0);
    hLowEEStat ->SetMarkerSize(2.7);
    hLowEESyst ->SetMarkerSize(2.7);
    hLowEESyst ->SetMarkerStyle(21);
    hLowEESyst ->SetMarkerColor(kBlue+1);
    hHighEESyst ->SetMarkerSize(2.7);
    hHighEESyst ->SetMarkerStyle(25);
    hHighEESyst ->SetMarkerColor(kOrange+10);
    ...
    l2a->AddEntry(hHighEESyst ,"(#sqrt{#it{s}} - ZDC) 0-30%, high eff. energy","P");
    l2a->AddEntry(hLowEESyst ,"(#sqrt{#it{s}} - ZDC) 70-100%, low eff. energy","P");
    ...
    //Mult Sel
    TCanvas* NchMultsel = new TCanvas("NchMultsel", "", 1600,1300);
    ...
    nee->GetYaxis()->SetRangeUser(0.2,1.8);
    nee->SetTitle("");
    nee->Draw();
    ...
    NormYieldsNchSyst_EEHighMult->SetLineColor(kMagenta+2);
    NormYieldsNchSyst_EEHighMult->SetLineWidth(1);
    NormYieldsNchStat_EEHighMult->SetLineColor(kMagenta+2);
    NormYieldsNchStat_EEHighMult->SetMarkerColor(kMagenta+2);
    NormYieldsNchStat_EEHighMult->SetMarkerStyle(kOpenCircle);
    NormYieldsNchStat_EEHighMult->SetMarkerSize(2.9);
    NormYieldsNchStat_EELowMult->SetMarkerColor(kGreen+3);
    NormYieldsNchStat_EELowMult->SetLineColor(kGreen+3);
    NormYieldsNchStat_EELowMult->SetMarkerStyle(kFullCircle);
    NormYieldsNchSyst_EELowMult->SetLineColor(kGreen+3);
    ...
    NormYieldsNchStat_EELowMult->SetMarkerSize(2.9);
    NormYieldsNchSyst_EELowMult->SetMarkerSize(2.9);
    NormYieldsNchSyst_EELowMult->SetMarkerStyle(kFullCircle);
    NormYieldsNchSyst_EELowMult->SetMarkerColor(kGreen+3);
    NormYieldsNchSyst_EEHighMult->SetMarkerSize(2.9);
    NormYieldsNchSyst_EEHighMult->SetMarkerStyle(kOpenCircle);
    NormYieldsNchSyst_EEHighMult->SetMarkerColor(kMagenta+2);
    ...
    lnmultsel->AddEntry(hHighMultSyst ,"V0M 0-30%, high multiplicity","P");
    lnmultsel->AddEntry(hLowMultSyst ,"V0M 70-100%, low multiplicity","P");
  ...
  //  texc->SetTextFont(42);
   ...
   // texb->SetLineWidth(2);
    ...
    NchMultsel->SaveAs("immaginifinali/D-DiffZDCSelV0M_Fixed_Nch.eps");
     ...
     //Mult Sel
    TCanvas* NchEEsel = new TCanvas("NchEEsel", "", 1600,1300);
    ...
    neea->GetYaxis()->SetRangeUser(0.2,1.8);
    neea->SetTitle("");
    neea->Draw();

    TLegend* lnEEsel = new TLegend (0.28,0.65,0.49,0.8);

    NchEEsel->SetRightMargin(0.09);
    NchEEsel->SetLeftMargin(0.25);
    NchEEsel->SetBottomMargin(0.15);
    
    NormYieldsNchSyst_HighEE->SetFillColorAlpha(kRed-10,0.1);
    NormYieldsNchSyst_HighEE->SetLineColor(kOrange+10);
    NormYieldsNchSyst_HighEE->SetLineWidth(1);
    NormYieldsNchStat_HighEE->SetLineColor(kOrange+10);
    NormYieldsNchStat_HighEE->SetMarkerColor(kOrange+10);
    NormYieldsNchStat_HighEE->SetMarkerStyle(25);
    NormYieldsNchStat_HighEE->SetMarkerSize(2.7);
    NormYieldsNchStat_LowEE->SetMarkerColor(kBlue+1);
    NormYieldsNchStat_LowEE->SetLineColor(kBlue+1);
    NormYieldsNchStat_LowEE->SetMarkerStyle(21);
    ...
    NormYieldsNchStat_LowEE->SetMarkerSize(2.7);
    NormYieldsNchSyst_LowEE->SetMarkerSize(2.7);
    NormYieldsNchSyst_LowEE->SetMarkerStyle(21);
    NormYieldsNchSyst_LowEE->SetMarkerColor(kBlue+1);
    NormYieldsNchSyst_HighEE->SetMarkerSize(2.7);
    NormYieldsNchSyst_HighEE->SetMarkerStyle(25);
    NormYieldsNchSyst_HighEE->SetMarkerColor(kOrange+10);
   ...
   // texb->SetLineWidth(2);
    ...
    lnEEsel->SetHeader("Effective energy selection:");
    lnEEsel->AddEntry(hHighEESyst ,"(#sqrt{#it{s}} - ZDC) 0-30%, high eff. energy","P");
    lnEEsel->AddEntry(hLowEESyst ,"(#sqrt{#it{s}} - ZDC) 70-100%, low eff. energy","P");
    lnEEsel->SetTextSize(0.027);
    ...
    NchEEsel->SaveAs("immaginifinali/D-DiffV0MSelZDC_Fixed_Nch.png");
     NchEEsel->SaveAs("immaginifinali/D-DiffV0MSelZDC_Fixed_Nch.png");
      NchEEsel->SaveAs("immaginifinali/D-DiffV0MSelZDC_Fixed_Nch.png");
    ...
    TCanvas* multV0 = new TCanvas("multV0", "", 1600,1300);
    ...
    gp->SetStats(0);
    gp->GetYaxis()->SetTitle("#left( #frac{ d#it{N}/d#it{y}}{#LT d#it{N}_{ch}/d#it{#eta} #GT _{|#it{#eta}|<0.5}} #right)_{Sel} / #left( #frac{ d#it{N}/d#it{y}}{#LT d#it{N}_{ch}/d#it{#eta} #GT _{|#it{#eta}|<0.5}} #right)_{MB}");
    ...
    gp->GetYaxis()->SetRangeUser(0.2,1.8);
    gp->SetTitle("");
    gp->Draw();
   ...
   // texb->SetLineWidth(2);
    ...
    multV0->SaveAs("immaginifinali/NormYields.eps");
    multV0->SaveAs("immaginifinali/NormYields.png");
    multV0->SaveAs("immaginifinali/NormYields.pdf");

    TCanvas* NchEE = new TCanvas("NchEE", "", 1600,1300);
    NchEE->SetFillColor(kWhite);
    NchEE->SetLogx();

    TH1D* neeb = new TH1D("nee", " ", 12, 2., 38);
    ...
    neeb->GetYaxis()->SetTitleSize(0.035);
    ...
    neeb->GetYaxis()->SetRangeUser(0.2,1.8);
    neeb->SetTitle("");

    neeb->Draw();

    NchEE->SetRightMargin(0.09);
    NchEE->SetLeftMargin(0.25);
   ...
   // NormYieldsNchSyst_EE ->SetFillColor(kBlack-10);
    NormYieldsNchStat_EE ->SetMarkerSize(2.9);
   // NormYieldsNchSyst_EE ->SetMarkerSize(2.2);
   // NormYieldsNchSyst_EE ->SetMarkerStyle(24);
 //   NormYieldsNchSyst_EE ->SetLineWidth(2);
    NormYieldsNchSyst_EE ->SetMarkerColor(kBlack+1);
   

  //  FiorSyst->SetFillColorAlpha(kRed-10,0.1);
    FiorSyst->SetLineColor(kBlack);
    FiorSyst->SetFillStyle(0);
    FiorSyst->SetLineWidth(1);
    FiorSyst->SetLineColor(kBlack);
    FiorStat->SetMarkerColor(kBlack);
    FiorStat->SetMarkerStyle(21);
    FiorStat->SetMarkerSize(2.4);
    FiorStat->SetLineColor(kBlack);
    FiorSyst->SetMarkerColor(kBlack);   
   ...
   /* Syst7->SetFillColorAlpha(kBlack,0.1);
   ...
   // NormYieldsNchSyst_Mult->Draw("E2 SAME");
    ...
    TMarker *markerc = new TMarker(20.,1.709863,2);
    markerc->SetMarkerStyle(2);
    markerc->SetMarkerSize(2.9);
    markerc->Draw("SAME");
    TMarker* marker2c = new TMarker(20.,1.62041,25);
    marker2c->SetMarkerStyle(25);
    marker2c->SetMarkerSize(2.8);
    marker2c->Draw("SAME");
  ...
  //  texc->SetTextFont(42);
   ...
   // texb->SetLineWidth(2);
    ...
    NchEE->Draw();
    NchEE->SaveAs("immaginifinali/D-DiffV0MZDC_Nch.eps");
