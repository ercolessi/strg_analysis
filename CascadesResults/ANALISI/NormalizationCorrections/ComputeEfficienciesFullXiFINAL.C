...
void ComputeEfficienciesFullXiFINAL(){
	...
	const char* outputname = "EventCountLoss_15g3c3_mergedbins.root";
    ...
    Float_t mult[] = {0,5,10,15,20,30,40,50,70,100};
    ...
    Float_t ee[] = {0,20,40,50,60,70,80,90,100}; 
