...
void DoSystOnSgnLossMergedBins(){
...
void signalloss(TString fWhichEstimator = "V0M", TString part = "XiMinus", TString dir = "multsel", TString histo = "V0") {   
        ...
        Int_t percentileV0[] = {0,5,10,15,20,30,40,50,70,100};
        const Long_t nbinV0 = sizeof(percentileV0)/sizeof(Int_t) - 1;
        //
        Int_t percentileZDC[] = {0,20,40,50,60,70,80,90,100};
        ...
        if (fWhichEstimator.Contains("V0M")) hRatioClone[8]->SetLineColor(kBlue+3);
