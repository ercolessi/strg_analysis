...
void DrawFinalPlots(){
    ...
    hMBstat->SetMarkerSize(5);
  
    TCanvas* multlow = new TCanvas("mult", "", 1700,1400);
    multlow->SetLogx();
    ...
    g3->SetStats(0);
    g3->GetYaxis()->SetTitle("#frac{  d#it{N}/d#it{y}  }{#LT d#it{N}_{ch}/d#it{#eta} #GT _{|#it{#eta}|<0.5}} ");
    ...
    multlow->SetRightMargin(0.05);
    multlow->SetLeftMargin(0.2);
    multlow->SetBottomMargin(0.15);

    TLegend* lnmultsel = new TLegend (0.29,0.6,0.49,0.8);
    
    hAvHighMultSyst->SetFillColor(kRed-10);
    hAvHighMultSyst->SetLineColor(kRed+1);
    hAvHighMultSystCorr->SetLineColor(kRed+1);
    hAvHighMultSystCorr->SetLineWidth(1);
    hAvHighMultStat->SetLineColor(kRed+1);
    hAvHighMultStat->SetMarkerColor(kRed+1);
    hAvHighMultStat->SetMarkerStyle(kFullCircle);
    hAvHighMultStat->SetMarkerSize(3.7);
    hAvLowMultStat->SetMarkerColor(kRed+1);
    hAvLowMultStat->SetLineColor(kRed+1);
    hAvLowMultStat->SetMarkerStyle(kOpenCircle);
    hAvLowMultSystCorr->SetLineColor(kRed+1);
    hAvLowMultSystCorr->SetFillColor(kBlack-10);
    hAvLowMultSystCorr->SetFillStyle(0);
    hAvHighMultSystCorr->SetFillStyle(0);
    hAvLowMultSyst->SetLineColor(kRed+1);
    hAvLowMultSyst->SetFillColor(kRed-10);
    hAvLowMultSyst->SetFillStyle(1001);
    hAvHighMultSyst->SetFillStyle(1001);
    hAvLowMultStat->SetMarkerSize(3.7);
    hAvLowMultSystCorr->SetMarkerSize(3.7);
    hAvLowMultSystCorr->SetMarkerStyle(kOpenCircle);
    hAvLowMultSystCorr->SetMarkerColor(kRed+1);
    hAvHighMultSystCorr->SetMarkerSize(3.7);
    hAvHighMultSystCorr->SetMarkerStyle(kFullCircle);
    hAvHighMultSyst->SetMarkerStyle(kFullCircle);
    hAvHighMultSyst->SetMarkerSize(3.7);
    hAvHighMultSystCorr->SetMarkerColor(kRed+1);
    ...
    lnmultsel->SetHeader("V0M multiplicity selection:");
    lnmultsel->AddEntry( hAvHighMultSystCorr,"0-30%, high mult.","P");
    lnmultsel->AddEntry(hAvLowMultSystCorr ,"70-100%, low mult.","P");
  ...
  //  texc->SetTextFont(42);
   ...
   // texb->SetLineWidth(2);
    ...
    hAvHighMultSyst->Draw("E2  SAME");
    hAvHighMultSystCorr->Draw("E2  SAME");
    hAvHighMultStat->Draw("P SAME");
    //
    hAvLowMultSyst->Draw("E2  SAME");
    hAvLowMultSystCorr->Draw("E2  SAME");
    ...
    TCanvas*  eelow = new TCanvas(" ee", "", 1700,1400);
    eelow->SetLogx();
    ...
    sg3->SetStats(0);
    sg3->GetYaxis()->SetTitle("#frac{  d#it{N}/d#it{y}  }{#LT d#it{N}_{ch}/d#it{#eta} #GT _{|#it{#eta}|<0.5}} ");
    ...
    eelow->SetRightMargin(0.05);
    eelow->SetLeftMargin(0.2);
    eelow->SetBottomMargin(0.15);

    hAvHighEESyst->SetLineColor(kBlue+1);
    hAvHighEESyst->SetLineWidth(1);
    hAvHighEESyst->SetFillColor(kBlue-10);
    hAvHighEESyst->SetFillStyle(1001);
    hAvHighEESystCorr->SetLineColor(kBlue+1);
    hAvHighEESystCorr->SetLineWidth(1);
    hAvHighEESystCorr->SetFillColor(kBlue-10);
    hAvHighEESystCorr->SetFillStyle(0);
    hAvHighEEStat->SetLineColor(kBlue+1);
    hAvHighEEStat->SetLineWidth(1);
    hAvHighEEStat->SetMarkerColor(kBlue+1);
    hAvHighEEStat->SetMarkerStyle(21);
    hAvHighEEStat->SetMarkerSize(3.7);
    //
    hAvLowEESyst->SetLineColor(kBlue+1);
    hAvLowEESyst->SetLineWidth(1);
    hAvLowEESyst->SetFillColor(kBlue-10);
    hAvLowEESyst->SetFillStyle(1001);
    hAvLowEESystCorr->SetLineColor(kBlue+1);
    hAvLowEESystCorr->SetLineWidth(1);
    hAvLowEESystCorr->SetFillColor(kBlue-10);
    hAvLowEESystCorr->SetFillStyle(0);
    hAvLowEESystCorr->SetMarkerStyle(21);
    hAvLowEESystCorr->SetMarkerSize(3.7);
    hAvLowEESyst->SetMarkerStyle(25);
    hAvLowEESyst->SetMarkerSize(3.7);
    hAvLowEEStat->SetLineColor(kBlue+1);
    hAvLowEEStat->SetLineWidth(1);
    hAvLowEEStat->SetMarkerColor(kBlue+1);
    hAvLowEEStat->SetMarkerStyle(25);
    hAvLowEEStat->SetMarkerSize(3.7);
    ...
    l2a->AddEntry(hAvHighEEStat ," 0-30%, high eff. energy","P");
    l2a->AddEntry(hAvLowEEStat ,"70-100%, low eff. energy","P");
    l2a->AddEntry(hMBstat ,"INEL>0","P");
    l2a->SetTextSize(0.037);
    l2a->SetTextFont(42);
    ...
    TCanvas* multlowperc = new TCanvas("multperc", "", 1700,1400);
    ...
    g3perc->SetStats(0);
    g3perc->GetYaxis()->SetTitle("#frac{  d#it{N}/d#it{y}  }{#LT d#it{N}_{ch}/d#it{#eta} #GT _{|#it{#eta}|<0.5}} ");
    ...
    multlowperc->SetRightMargin(0.05);
    multlowperc->SetLeftMargin(0.2);
    multlowperc->SetBottomMargin(0.15);

    hAvHighMultSystpercentile->SetLineColor(kRed+1);
    hAvHighMultSystpercentile->SetLineWidth(1);
    hAvHighMultSystpercentile->SetFillColor(kRed-10);
    hAvHighMultSystpercentile->SetFillStyle(1001);
    hAvHighMultSystCorrpercentile->SetLineColor(kRed+1);
    hAvHighMultSystCorrpercentile->SetLineWidth(1);
    hAvHighMultSystCorrpercentile->SetFillColor(kRed-10);
    hAvHighMultSystCorrpercentile->SetFillStyle(0);
    hAvHighMultStatpercentile->SetLineColor(kRed+1);
    hAvHighMultStatpercentile->SetLineWidth(1);
    hAvHighMultStatpercentile->SetMarkerColor(kRed+1);
    hAvHighMultStatpercentile->SetMarkerStyle(kFullCircle);
    hAvHighMultStatpercentile->SetMarkerSize(2.9);
    //
    hAvLowMultSystpercentile->SetLineColor(kRed+1);
    hAvLowMultSystpercentile->SetLineWidth(1);
    hAvLowMultSystpercentile->SetFillColor(kRed-10);
    hAvLowMultSystpercentile->SetFillStyle(1001);
    hAvLowMultSystCorrpercentile->SetLineColor(kRed+1);
    hAvLowMultSystCorrpercentile->SetLineWidth(1);
    hAvLowMultSystCorrpercentile->SetFillColor(kRed-10);
    hAvLowMultSystCorrpercentile->SetFillStyle(0);
    hAvLowMultStatpercentile->SetLineColor(kRed+1);
    hAvLowMultStatpercentile->SetLineWidth(1);
    hAvLowMultStatpercentile->SetMarkerColor(kRed+1);
    hAvLowMultStatpercentile->SetMarkerStyle(kOpenCircle);
    ...
    texbr->SetTextSize(0.04008798);
   // texb->SetLineWidth(2);
    texbr->Draw("SAME");
    texbbr->SetTextSize(0.04008798);
   // texb->SetLineWidth(2);
    texbbr->Draw("SAME");    
    ...
    l21->SetBorderSize(0);
    l21->SetHeader("V0M multiplicity:");
    l21->AddEntry( hAvHighMultStat,"0-30%, high mult.","P");
    l21->AddEntry( hAvLowMultStat,"70-100%, low mult.","P");
    TLegend* l21l = new TLegend (0.28229276,0.50894,0.506995,0.8218088);

    l21l->SetBorderSize(0);
    l21l->AddEntry(lmb,"INEL>0, stat. (dashed line) syst. (band)","L");
    l21->SetTextSize(0.027);
    l21->SetTextFont(42);
    l21->Draw("SAME");
    l21l->SetTextSize(0.027);
    l21l->SetTextFont(42);
    l21l->Draw("SAME");
    ...
    TCanvas*  eelowperc = new TCanvas(" eeperc", "", 1700,1400);
     //eelowperc->SetGridy();
     eelowperc->SetTicky();
     eelowperc->SetTickx();
    // eelowperc->SetLogx();
    ...
    g1perc->SetStats(0);
    g1perc->GetYaxis()->SetTitle("#frac{  d#it{N}/d#it{y}  }{#LT d#it{N}_{ch}/d#it{#eta} #GT _{|#it{#eta}|<0.5}} ");
    g1perc->GetYaxis()->SetTitleSize(0.05);
    g1perc->GetYaxis()->SetTitleOffset(1.9);
    g1perc->GetXaxis()->SetTitle("V0M percentile (%)");
    g1perc->GetXaxis()->SetTitleSize(0.05);
    ...
    g1perc->Draw();
     ...
     eelowperc->SetRightMargin(0.05);
     eelowperc->SetLeftMargin(0.2);
     eelowperc->SetBottomMargin(0.15);

    hAvHighEESystpercentile->SetLineColor(kBlue+1);
    hAvHighEESystpercentile->SetLineWidth(1);
    hAvHighEESystpercentile->SetFillColor(kBlue-10);
    hAvHighEESystpercentile->SetFillStyle(1001);
    hAvHighEESystCorrpercentile->SetLineColor(kBlue+1);
    hAvHighEESystCorrpercentile->SetLineWidth(1);
    hAvHighEESystCorrpercentile->SetFillColor(kBlue-10);
    hAvHighEESystCorrpercentile->SetFillStyle(0);
    hAvHighEEStatpercentile->SetLineColor(kBlue+1);
    hAvHighEEStatpercentile->SetLineWidth(1);
    hAvHighEEStatpercentile->SetMarkerColor(kBlue+1);
    hAvHighEEStatpercentile->SetMarkerStyle(21);
    hAvHighEEStatpercentile->SetMarkerSize(3.7);
    //
    hAvLowEESystpercentile->SetLineColor(kBlue+1);
    hAvLowEESystpercentile->SetLineWidth(1);
    hAvLowEESystpercentile->SetFillColor(kBlue-10);
    ...
    hAvLowEESystCorrpercentile->SetFillColor(kBlue-10);
    ...
    hAvLowEEStatpercentile->SetMarkerStyle(25);
    hAvLowEEStatpercentile->SetMarkerSize(3.7);
    ...
    hAvHighEESystpercentile->Draw("E2  SAME");
    hAvLowEESystpercentile->Draw("E2  SAME");
    hAvHighEESystCorrpercentile->Draw("E2  SAME");
    
    //
    
    hAvLowEESystCorrpercentile->Draw("E2  SAME");
    ...
    l2a1->SetHeader("(#sqrt{#it{s}} - ZDC) effective energy:");
    l2a1->AddEntry(hAvHighEEStat ,"0-30%, high eff. energy","P");
    l2a1->AddEntry(hAvLowEEStat ,"70-100%, low eff. energy","P");
    l2a1->AddEntry(lmb,"INEL>0, stat. (dashed line) syst. (band)","L");
    l2a1->SetTextSize(0.037);
    l2a1->SetTextFont(42);
