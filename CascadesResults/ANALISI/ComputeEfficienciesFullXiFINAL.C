...
void ComputeEfficienciesFullXiFINAL(){
	...
	TFile* file = new TFile("MCLHC16d3.root","READ");
		//"MCLHC17j_GP.root"
	const char* ZDCFilename = "ExtractedZDCPercentile_MC-16d3.root"; //""
    const char* ZDCpartfilename = ZDCFilename; //""
	const char* outputname = "EventCountLoss_16d3.root";
    ...
    Float_t ee[] = {0,20,30,40,50,60,70,80,90,100}; 
